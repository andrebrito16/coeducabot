...
module.exports.run = async (bot, message, args) => {
    ...
    .setColor("#FFFFFF")
    .setDescription(`<:Cross:761192023084105728> You need 2000 coins to purchase Bronze VIP`);
    ...
    if (args[0] == 'bronze') {
        ...
        .setColor("#FFFFFF")
        .setDescription(`<:Check:761192023084105728> Purchased Bronze VIP For 3500 Coins`);
